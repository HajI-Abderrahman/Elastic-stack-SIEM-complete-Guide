...
- ubuntu  server 22.04
- Fortigate FW
- and other sytem sources such us : (CISCO SWs, Tripwire, Wallix, PaloALto FW, Cloud AZUR,PGP, other linux distrubuation ….) that are Upcoming
...
1. **Configurer les VMs dans VMware**
    ...
    ![image.png](Elasctic%20stack%20Lab%20version%201/image.png)
